package com.spring.bittlebittle.user1.controller;
...
import com.spring.bittlebittle.user1.service.UserService;
import com.spring.bittlebittle.user1.vo.User;
import com.spring.bittlebittle.utils1.JwtRequest;
import com.spring.bittlebittle.utils1.JwtTokenUtil;
...
public class UserController {
    ...
    public Map<String, Object> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        boolean isValidUser = userService.checkPassword(authenticationRequest.getUsername(), authenticationRequest.getuserPwd);
        ...
        if (isValidUser) {
            ...
            response.put("userId", authenticationRequest.getUsername());
